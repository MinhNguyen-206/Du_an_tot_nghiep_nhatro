    ...
    public OpenAPI nhaTroOpenAPI() {
        return new OpenAPI()
                ...
                .tags(Arrays.asList(
                        ...
                        createTag("Giao dịch thanh toán", "Quản lý giao dịch và chi trả thanh toán"),
                        createTag("Thanh toán cọc", "Quản lý tiền cọc và lịch sử thanh toán"),
                        createTag("Gói dịch vụ", "Quản lý các gói dịch vụ trả phí"),
                        createTag("Lịch sử gói chủ trọ", "Quản lý lịch sử đăng ký gói dịch vụ chủ trọ"),
                        ...
                        createTag("Nhật ký hoạt động", "Quản lý nhật ký hoạt động của người dùng"),
