    ...
    <div class="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between text-sm">
        ...
        <div class="flex items-center space-x-3 text-xs">
            ...
            <a
                    ...
                    class="font-semibold px-2 hover:text-brand"
            >
                Đăng nhập
            </a>
    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="bg-white rounded-2xl p-4 shadow-2xl text-gray-800">
            ...
            >
                ...
                <div
                        class="flex-1 flex items-center bg-gray-100 rounded-xl px-3 py-2"
                >

                    <i
                            class="fa-solid fa-magnifying-glass text-gray-400 mr-2"
                    ></i>

                    <input
                            type="text"
                            name="keyword"
                            placeholder="Nhập khu vực, trường học..."
        ...
        >
            ...
            <div>
                ...
                <div class="p-3">
                    ...
                    <h3
                            class="text-xs font-bold line-clamp-2 text-gray-800 mb-2"
                    >
                        <%= room.get("title") %>
                    </h3>
...
<footer
        class="bg-white border-t border-gray-200 mt-auto py-6 text-gray-600 text-xs text-center"
>
