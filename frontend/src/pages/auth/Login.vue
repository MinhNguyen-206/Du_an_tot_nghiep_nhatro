        ...
        <form @submit.prevent="handleLogin">
          ...
          <div class="field">
            <div class="field__row">
              ...
              <router-link to="/forgot-password" class="link-muted">Quên mật khẩu ?</router-link>
            </div>
...
// TODO: nối OAuth Google/Facebook khi backend có endpoint tương ứng
...
const GoogleIcon = () =>
  h('svg', { width: 18, height: 18, viewBox: '0 0 24 24' }, [
    h('path', { fill: '#4285F4', d: 'M23.52 12.27c0-.82-.07-1.6-.2-2.36H12v4.47h6.47a5.53 5.53 0 0 1-2.4 3.63v3h3.88c2.27-2.09 3.57-5.17 3.57-8.74Z' }),
    h('path', { fill: '#34A853', d: 'M12 24c3.24 0 5.96-1.07 7.95-2.9l-3.88-3a7.4 7.4 0 0 1-4.07 1.14c-3.13 0-5.78-2.11-6.73-4.96H1.26v3.1A12 12 0 0 0 12 24Z' }),
    h('path', { fill: '#FBBC05', d: 'M5.27 14.28A7.2 7.2 0 0 1 4.89 12c0-.79.14-1.56.38-2.28v-3.1H1.26A12 12 0 0 0 0 12c0 1.94.47 3.77 1.26 5.38l4.01-3.1Z' }),
    h('path', { fill: '#EA4335', d: 'M12 4.77c1.76 0 3.34.6 4.58 1.79l3.44-3.44C17.95 1.19 15.24 0 12 0A12 12 0 0 0 1.26 6.62l4.01 3.1C6.22 6.88 8.87 4.77 12 4.77Z' })
  ])
...
.auth-visual__overlay {
  position: absolute;
  inset: 0;
  background: linear-gradient(0deg, rgba(6,20,15,0.75) 0%, rgba(6,20,15,0.15) 55%, rgba(6,20,15,0.55) 100%);
}
...
.auth-subtitle { margin: 0 0 32px; color: #555; font-size: 15px; line-height: 1.5; }
.auth-subtitle em { font-style: italic; }
...
.link-muted { font-size: 13px; font-weight: 700; color: #111; text-decoration: none; }
...
.social-row { display: flex; gap: 16px; margin-bottom: 28px; }
.btn-social {
  flex: 1;
  display: flex;
  align-items: center;
...
.btn-social:hover { background: #f8f8f8; }
